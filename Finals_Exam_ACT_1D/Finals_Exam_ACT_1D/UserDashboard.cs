    ...
    public partial class UserDashboard : Form
    {
        ...
        private void LoadVehicle()
        {
...

            {
                ...
                string query = @"SELECT vehicle_id, Name, contact, User_Id, Vehicle_type, Vehicle_model, Plate_number, availability FROM vehicle WHERE Name LIKE @search OR contact LIKE @search OR User_Id LIKE @search OR Vehicle_type LIKE @search OR Vehicle_model LIKE @search OR Plate_Number LIKE @search OR availability LIKE @availability";
